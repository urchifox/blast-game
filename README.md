...
- The **flow layer** coordinates user actions, domain operations, boosters, progress, and presentation.
...
- `src/game-blast/flow/` — gameplay coordination, actions, boosters, and progress.
